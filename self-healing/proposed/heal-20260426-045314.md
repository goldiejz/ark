...
session id: 019dc821-8807-79a3-8bdc-e3d3e5de8a45
--------
user
...
**Phase:** 1
**Task:** Create src/worker.ts with a Hono app exporting default fetch handler. GET / returns JSON {hello: "world"}. Apply the project's RBAC and tenant conventions where applicable.
